...
const Sidebar = () => {
  return (
    <div className="">
      <div className="lg:fixed lg:w-[350px] lg:top-1/2 lg:-translate-y-1/2 left-10 lg:border border-borderGray lg:p-6 rounded-4xl flex flex-col items-center space-y-6">
